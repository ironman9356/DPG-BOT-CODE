...
#   pattern=re.compile("\<*[Aa]*\:[nedNED]+[DYdy]*\_*[danceDANCE]*\:[0-9]*\>*")
#   result=pattern.findall(message.content)
#   print(result)
#   print(message.content)
#   print(message.content.lower() in result)
#   if message.author.bot: 
#     return
#   for i in result :

#     if message.content.lower() in i == False :
